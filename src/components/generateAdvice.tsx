        ...
        >
            <div className="w-full flex-1 mt-36 flex items-center px-40 max-[800px]:items-start max-[800px]:pt-20 max-[800px]:justify-center">
                <div className="flex flex-col text-white space-y-8">
                    ...
                    <p className="w-96 text-base tracking-widest opacity-80">CLICK THE ADVICE BUTTON TO GET A RANDOM ADVICE FROM API</p>
                </div>
                <div onClick={handleClick} className="absolute bottom-10 shadow-2xl cursor-pointer left-3/4 w-40 h-40 rounded-full bg-white flex justify-center items-center max-[800px]:left-1/2">
